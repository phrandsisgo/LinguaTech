...
<p class="pagetitle">Eine Neue Liste Kreiren</p>
    ...
    <input type="text" name="listDescription" id="listDescription" placeholder="Beschreibung" class="inputField">
     ...
     <div id="luis">
        <div class="library-Card">
            <input type="text" name="baseWord" id="baseWord" value="{{ $begriffe->base_word}}" class="inputField">
            <p class="formHelper">Base Language</p>

            <input type="text" name="targetWord" id="targetWord" value="{{$begriffe->target_word}}" class="inputField">
