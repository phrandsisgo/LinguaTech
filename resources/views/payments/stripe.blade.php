        ...
        <div class="col-md-5">
            <div class="card mb-5 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    @else
                        <a href="/library" class="btn btn-lg btn-block btn-outline-primary">{{ __('stripe.go_to_library') }}</a>
                    @endguest
                </div>
            </div>
        </div>
        ...
        <div class="col-md-5">
            <div class="card mb-5 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <button id="checkout-button" class="btn btn-lg btn-block btn-primary">{{ __('stripe.subscribe_now') }}</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="col-md-5">
            <div class="card mb-5 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <button id="checkout-button" class="approveButton">{{ __('stripe.subscribe_now') }}</button>
                </div>
            </div>
        </div>
    </div>
